...
class ArmazenadorInfoObjetos {
	...
	static get infoAviaoMasterPers() {
		...
		infoArmasLateral.freqAtirar = frequenciaAtirar(45)
		...
		infoArmaGiratoria.freqAtirar = frequenciaAtirar(5)
	...
	*/
			...
			case "AviaoMaster":
				{
					...
					//INFO ARMAS
					{
						...
						const infoTiroMedio = ArmazenadorInfoObjetos.infoTiro("TiroMedio", false);
						{
							...
							infoArmaLateral1.freqAtirar = frequenciaAtirar(freqTirosNormais)
							...
							infoArmaLateral4.freqAtirar = frequenciaAtirar(freqTirosNormais)
							...
							infoArmaLateral5.freqAtirar = frequenciaAtirar(freqTirosNormais)
							...
							infoArmaLateral8.freqAtirar = frequenciaAtirar(freqTirosNormais)
						...
						const infoTiroForte = ArmazenadorInfoObjetos.infoTiro("TiroForte", false);
						{
							...
							infoArmaLateral2.freqAtirar = frequenciaAtirar(freqTirosNormais)
							...
							infoArmaLateral3.freqAtirar = frequenciaAtirar(freqTirosNormais)
						...
						const infoTiroMissil = ArmazenadorInfoObjetos.infoTiro("TiroMissilPior", false);
						{
							...
							infoArmaLateral6.freqAtirar = frequenciaAtirar(freqAtirarMisseis)
							...
							infoArmaLateral7.freqAtirar = frequenciaAtirar(freqAtirarMisseis)
						...
						const indexArmaGiratoria = 0;
						{
							...
							infoArmaGiratoria.freqAtirar = frequenciaAtirar(22)
							infoArmaGiratoria.indexArmaGiratoria = indexArmaGiratoria;
			...
			case "AviaoBrutao":
				{
					...
					infoArmaLateral1.freqAtirar = frequenciaAtirar(freqTiroLaterais)
					infoArmaLateral1.direcaoSairTiro = Direcao.Baixo;
					...
					infoArmaLateral2.freqAtirar = frequenciaAtirar(freqTiroLaterais)
					infoArmaLateral2.direcaoSairTiro = Direcao.Baixo;
			...
			case "AviaoBrutoSemHel":
				{
					...
					infoArma.freqAtirar = frequenciaAtirar(45)
			...
			case "HelicopteroBom":
				{
					...
					infoArmaCentro.freqAtirar = frequenciaAtirar(30)
			...
			case "AviaoSupersonicoForte":
				{
					...
					infoArma.freqAtirar = frequenciaAtirar(11)
					infoArma.direcaoSairTiro = Direcao.Baixo;
					infoArma.porcPraDentroObj = 0;
					infoArma.ehTiroDuplo = false;
					infoArmas.push(infoArma);
			...
			case "AviaoNormalBomClaro":
				{
					...
					let infoArma = new InfoArma();
					infoArma.infoTiroPadrao = ArmazenadorInfoObjetos.infoTiro("TiroMedio", false);
					infoArma.freqAtirar = frequenciaAtirar(12)
					infoArma.direcaoSairTiro = Direcao.Baixo;
					infoArma.porcPraDentroObj = 0;
					infoArma.ehTiroDuplo = false;
					infoArmas.push(infoArma);
	...
	static get infoSuporteAereo() {
		...
		infoArmasLaterais.freqAtirar = frequenciaAtirar(7)
		...
		infoArmaCentralLateral.freqAtirar = frequenciaAtirar(freqAtirarArmasCentro)
		...
		infoArmaCentralMeio.freqAtirar = frequenciaAtirar(freqAtirarArmasCentro)
...
//velocidade
const velPadrao = 200 / frameRatePadrao;
...
//vida
const vidaPadrao = 150;
function vida(nivel) { return nivel * vidaPadrao; }

//mortalidadeTiro
const mortalidadeTiroPadrao = 2.5;
function mortalidadeTiro(nivel) { return nivel * mortalidadeTiroPadrao; }

//para colisoes objetos com pers que tiram vida:
const mortalidadeObjBatePersPadrao = 4;
function mortalidadeObjBatePers(nivel) { return mortalidadeObjBatePersPadrao * nivel; }
const mortalidadeObjNaoConsegueEmpurrarPersPadrao = vidaPadrao / 3;
function mortalidadeObjNaoConsegueEmpurrarPers(nivel) { return mortalidadeObjNaoConsegueEmpurrarPersPadrao * nivel; }
