...
class ConjuntoTimers {
	...
	//metodos
	static adicionarTimer(novoTimer) { ConjuntoTimers._timers.push(novoTimer); }
	static procDraws() {
	...
	static excluirTimers() { ConjuntoTimers._timers = []; }
	...
	//POCAO
	static mudarTempo(porcentagem) { ConjuntoTimers._timers.forEach(tmrAtual => tmrAtual.mudarTempo(porcentagem)); }
}
