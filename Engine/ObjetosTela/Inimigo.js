...
class InfoInimigo extends InfoObjetoComArmas_e_Vida {
	...
	clone() { return new InfoInimigo(this.formaGeometrica, this.infoImgVivo.clone(), this.infoImgMorto.clone(), this.vida, AuxInfo.cloneImgCor(this.corVida), this.mostrarVidaSempre, this.porcentagemTempoVida, this.qtdTiraVidaBatePers, this.qtdTiraVidaNaoConsegueEmpurrarPers, this.infoAndar.clone(), this.rotacionarInimAnguloAnda, Clone.cloneVetorCadaElemento(this.infoArmas), this.qtdHelices, Clone.cloneVetor(this.qtdsRotateDifHelices), this.ehInimEssencial); }
}
class Inimigo extends ObjetoComArmas_e_Vida {
	...
	get classeAndar() { return this._classeAndar; }
	...
	get qtdTiraVidaBatePers() { return this._qtdTiraVidaBatePers; }
	...
	get mostrarVidaSempre() { return this._mostrarVidaSempre; }

	//verificar colidir com personagem e fazer devidos procedimentos se colidir
	qtdPersPodeAndar(infoQtdMudar) { AuxObjetos.qtdPersPodeAndar(this, infoQtdMudar); }
	...
	//desenho
	get corVida() { return this._corVida; }
	set corVida(vida) { this._corVida = vida; }
	draw()
...
class ControladorInimigos {
	...
	//setter
	set indexContr(indexContr) { this._indexContr = indexContr; }

	//getters basicos
	get infoInimigoPadrao() { return this._infoInimigoPadrao; }
	get ehDeInimigosEssenciais() { return this._ehDeInimigosEssenciais; }
	get inimigos() { return this._inimigos; }
	...
	algumInimNaTela() { return this._inimigos.length > 0 || this._inimigosSurgindo.length > 0; }

	//para ver se pode atirar missil em AviaoMaster
	algumInimVivo() { return this._inimigos.some(inim => inim.vivo); }
	...
	drawTirosMortosInims() { this._inimigos.forEach(inim => inim.drawTirosMortos()); }
