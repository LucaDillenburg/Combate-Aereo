...
class InfoImg
{
  ...
  clone()
  { return new InfoImg(Clone.cloneVetor(this.vetorImg), this.qtdVezesPrintarCadaImg); }
}
class InfoImgVivo extends InfoImg
{
  ...
  clone()
  { return new InfoImgVivo(Clone.cloneVetor(this.vetorImg), this.qtdVezesPrintarCadaImg, this.indexInicial); }
}
...
class InfoImgMorto extends InfoImg
{
  ...
  clone()
  { return new InfoImgMorto(Clone.cloneVetor(this.vetorImg), this.qtdVezesPrintarCadaImg, this.infoAdicionarImgSec); }
}
