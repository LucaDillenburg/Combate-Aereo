...
class InfoSuporteAereo extends InfoObjetoComArmas
{
  ...
  clone()
  { return new InfoSuporteAereo(this.formaGeometrica, this.infoImgVivo.clone(), this.infoImgMorto.clone(), Clone.cloneVetorCadaElemento(this.infoArmas), this.qtdTiraVidaNaoConsegueEmpurrarPers, this.qtdHelices, Clone.cloneVetor(this.qtdsRotateDifHelices)); }
}
