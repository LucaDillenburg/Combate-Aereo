...
class InfoSuporteAereo extends InfoObjetoComArmas {
	...
	clone() { return new InfoSuporteAereo(this.formaGeometrica, this.infoImgVivo.clone(), this.infoImgMorto.clone(), Clone.cloneVetorCadaElemento(this.infoArmas), this.qtdTiraVidaNaoConsegueEmpurrarPers, this.qtdHelices, Clone.cloneVetor(this.qtdsRotateDifHelices)); }
}
...
class ControladorSuportesAereos {
	...
	get suportesAereos() { return this._suportesAereos; }
	zerarSuportesAereos() {
	...
	//draw
	draw() { this._suportesAereos.forEach(suporteAereo => suporteAereo.draw()); }
	drawSurgindo() { this._suportesAereosSurgindo.forEach(suporteAereoSurgindo => suporteAereoSurgindo.draw()); }
