...
class InfoObstaculo extends InfoObjetoTela {
	...
	clone() { return new InfoObstaculo(this.formaGeometrica, this.infoImgVivo.clone(), this.infoImgMorto.clone(), this.infoAndar.clone(), this.qtdTiraVidaBatePers, this.qtdTiraVidaNaoConsegueEmpurrarPers, this.anguloRotacionarObst); }
}
class Obstaculo extends ObjetoTela {
	...
	get explodiu() { return this._explodiu; }
	...
	get qtdTiraVidaNaoConsegueEmpurrarPers() { return this._qtdTiraVidaNaoConsegueEmpurrarPers; }
...
class InfoObstaculoComVida extends InfoObstaculo {
	...
	clone() { return new InfoObstaculoComVida(this.formaGeometrica, this.infoImgVivo.clone(), this.infoImgMorto.clone(), this.infoAndar.clone(), this.qtdTiraVidaNaoConsegueEmpurrarPers, this.vida, this.anguloRotacionarObst); }
}
...
class ControladorObstaculos {
	...
	get infoObstaculoPadrao() { return this._infoObstaculoPadrao; }
