...
class InfoTiro extends InfoObjetoTela {
	...
	clone() { return new InfoTiro(this.formaGeometrica, this.infoImgVivo.clone(), this.infoImgMorto.clone(), this.infoAndar.clone(), this.mortalidade, this.ehDoPers); }
}
class Tiro extends ObjetoTela {
	...
	get mortalidade() { return this._mortalidade; }
	set mortalidade(qtd) { this._mortalidade = qtd; }
	...
	get ehDoPers() { return this._ehDoPers; }
	...
	tirarVidaObjCmVida(obj) { obj.mudarVida(-this._mortalidade); }
}
...
class ControladorTiros {
	...
	//infoTiroPadrao
	get infoTiroPadrao() { return this._infoTiroPadrao; }
