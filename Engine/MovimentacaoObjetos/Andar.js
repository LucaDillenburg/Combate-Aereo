...
class ClasseAndar {
	...
	get ehParado() { return this._qtdAndarX === 0 && this._qtdAndarY === 0; }
	...
	static getAnguloQtdAndar(qtdAndarX, qtdAndarY) { return Math.atan2(qtdAndarX, qtdAndarY * -1); }
	...
	_tipoTemHipotenusaPadrao() { return this._tipoAndar === TipoAndar.SeguirPers || this._tipoAndar === TipoAndar.SeguirInimMaisProx || this._tipoAndar === TipoAndar.SeguirPonto; }
	_colocarHipotenusaPadrao() { this._hipotenusaPadrao = Operacoes.hipotenusa(this._qtdAndarX, this._qtdAndarY); }
