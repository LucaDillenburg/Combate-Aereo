...
class InfoObjetoTelaAparecendo extends InfoObjetoTelaSimples
{
  ...
  clone()
  { return new InfoObjetoTelaAparecendo(this.mudarOpacidade, this.mudarTamanho, Clone.cloneDicionario(this.qtdAndar), (this.formaGeometrica===undefined)?undefined:this.formaGeometrica.clone(), this.infoImgVivo.clone(), this.qtdHelices, Clone.cloneVetor(this.qtdsRotateDifHelices)); }
}
